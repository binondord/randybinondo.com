...
export default function CardSkillsTable({ color }) {
  return (
    <>
      <div
        className={
  ...
  <nav className="block">
    <ul className="flex pl-0 rounded list-none flex-wrap">
      <li>
        <a href="#pablo" className="first:ml-0 text-xs font-semibold flex w-8 h-8 mx-1 p-0 rounded-full items-center justify-center leading-tight relative border border-solid border-blueGray-200 text-white bg-blueGray-200">
...
CardSkillsTable.defaultProps = {
  color: "light",
};

CardSkillsTable.propTypes = {
